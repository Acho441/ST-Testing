...
if __name__ == '__main__':
    ...
    from ST_Testing.projects.hw15.password_utilities import evaluate_strength
app = Flask(__name__)
...
To call the API with a GET request, make an http req like:
...
For the purposes of our testing, use requests package to make HTTP requests.
