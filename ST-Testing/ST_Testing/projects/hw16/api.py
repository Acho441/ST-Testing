...
"""
To run this Flask app, at the command line,
while in the folder for this homework
...
To call the API with a GET request,
make an http request like the following in your browser:
...
we use the requests package to make HTTP requests.
...
def get_password_strength_by_post():
    ...
    if 'password' not in data:
        return jsonify({"error": "Missing key 'P' in the JSON payload"}), 400
