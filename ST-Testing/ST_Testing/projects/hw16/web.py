...
This web app also has a path that accepts http POSTs,
but that is not connected
to any web page. You will get an error
if you try to access it directly in your browser.
"""
...
def lookup_password():
    ...
    response = requests.post(f"{api_host}/get_strength",
